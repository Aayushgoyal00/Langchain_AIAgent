...
# prompt1 = template1.invoke({"text": text_to_summarize})
# result1 = model.invoke(prompt1.text) 
# print(result1)
# prompt2 = template2.invoke({"text2": prompt1})
# result2 = model.invoke(prompt2.text)
# print(result2)
